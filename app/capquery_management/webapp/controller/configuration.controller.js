sap.ui.define([
    ...
    function (Controller, JSONModel, Fragment, Filter, FilterOperator, FilterType, MessageBox) {
        ...
        return Controller.extend("capquerymanagement.controller.configuration", {
            onInit: function () {
            ...
            onCreate: function () {
                ...
                if (!this._oDialogItem) {
                    this._oDialogItem = sap.ui.xmlfragment("capquerymanagement.fragments.addServiceParameter", this);
